...
class WbSpider(scrapy.Spider):
    name = "veera"
    custom_settings = {'ROTATING_PROXY_LIST_PATH': 'D:/BigProject/wildberries/proxy_http1.txt'}
...
# scrapy crawl zonti -O zonti.csv
# scrapy crawl veera -O veera.csv
# scrapy crawl rel -O religioznie.csv
